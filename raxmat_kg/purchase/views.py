...
from cart.forms import OrderUser
...
def order_detail(request):
    return render_to_response('order_detail.html', {'username': auth.get_user(request).username})


def order_list(request):
    return render_to_response('order_list.html', {'username': auth.get_user(request).username})
